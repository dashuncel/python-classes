...
# суперкласс летающие
class Flying:
  def startFly(self, height, speed):
...
class Cow(Animal):
  ...
  def __str__(self):
    return "Это %s, которая дает %s литров молока в день" % (self.name, self.milk)
...
print(goose)
print(goose.getVoice())

duck = Duck(15, "duck", 50)
print(duck)
print(duck.startFly(100, 100))
